                ...
                if (idToken != tokens.end()){
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            (*childNode)->AddEdgeToParentNode(edge.get());          //child node is not exclusive owner of edge
                            (*parentNode)->AddEdgeToChildNode(std::move(edge));     //parent node becomes exclusive owner of edge
                        }
